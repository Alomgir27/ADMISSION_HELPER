...
// function selected(x){
//     for(var i = 0; i < navbarItems.children.length; ++i){
//         if(i == x){
//             navbarItems.children[i].classList.add("navItemSelected");
//         }
//         else if(navbarItems.children[i].classList.contains('navItemSelected')){
//             navbarItems.children[i].classList.remove("navItemSelected");
//         }
//     }
// }
// selected(0);
